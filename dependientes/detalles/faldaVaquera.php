...
<body>
	...
	<header>
        ...
        <nav>
                <ul>
                        ...
                        <li class="Minibarra8">
                           <a class="estaSI Calzado" href="../../probador/vestuario/pago/pagoPedido.php">
                                Enviar el ticket de compra<img src="../Barra/Iconos/ticket.png"
                                onmouseover="src='../Barra/Iconos/ticket2.png'"
                                onmouseout="src='../Barra/Iconos/ticket.png'"
                                class="iconos">
                            </a>
                        </li>
                        <li class="Minibarra9">
                            <a class="estaSI Ofertas" href="../../probador/vestuario/probador.html">
                            Servir pedido<img src="../Barra/Iconos/euroIcono.png"
	...
	<?php
			...
			$consulta='select * from faldas where id=6';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/faldaVaquera2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaVaquera3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/faldaVaquera1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaVaquera2.jpg" alt="">
							</div>
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<input class="nuevoP" type="text" name="correo" placeholder="Editar precio">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(0, 146, 214);"></a></li>
								</ul>
							</div>
