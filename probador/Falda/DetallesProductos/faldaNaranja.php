				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							<div class="product-view">
								<img src="img/faldaNaranja1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaNaranja2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaNaranja3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Falda Naranja</h2>
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(223, 94, 43);"></a></li>
								</ul>
							</div>
