...
<body>
	...
	<?php
			...
			$consulta='select * from faldas where id=4';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/faldaPunk2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaPunk3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/faldaPunk1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaPunk2.jpg" alt="">
							</div>
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(25, 5, 71);"></a></li>
								</ul>
							</div>
