...
<body>
	...
	<?php
			...
			$consulta='select * from faldas where id=1';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/faldaMilitar2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaMilitar3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/faldaMilitar1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaMilitar2.jpg" alt="">
							</div>
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(16, 41, 17);"></a></li>
								</ul>
							</div>
