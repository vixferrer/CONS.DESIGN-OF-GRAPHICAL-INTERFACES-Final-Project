...
<body>
			...
			<nav>
			 <ul>
			   ...
			   <li><a class="estaSI" href="../../Jersey/Jersey.html">Jerseys<img src = "../Barra/Iconos/jersey.png" 
				   ...
				   class="iconos"></a></li>
			   <li class="marcada"><a href="../Falda.html">Faldas<img src = "../Barra/Iconos/faldaBLANCO.png" 
				   class="iconos"></a></li>
	...
	<div class="section">
		...
		<?php
			...
			$re=mysqli_query($con, "select * from calzado where id=5") or die(mysql_error());
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							<div class="product-view">
								<img src="img/faldaCorta1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaCorta2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/faldaCorta3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Falda Corta</h2>
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(190, 12, 12);"></a></li>
								</ul>
							</div>
