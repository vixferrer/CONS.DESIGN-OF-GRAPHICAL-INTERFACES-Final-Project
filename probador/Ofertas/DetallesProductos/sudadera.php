...
<head>
    ...
    <title>Sudadera Strange Things</title>
...
<body>
               ...
               <nav>
                <ul>
                  ...
                  <li><a class="estaSI" href="../../Calzado/Calzado.php">Calzado<img src = "../Barra/Iconos/calzado.png" 
                      ...
                      class="iconos"></a></li>
                  <li class="marcada"><a href="../Ofertas.php">Ofertas<img src = "../Barra/Iconos/ofertasBLANCO.png"
					  class="iconos"></a></li>  
	...
	<?php
			...
			$consulta='select * from ofertas where id=5';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/sudadera2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/sudadera3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/sudadera1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/sudadera2.jpg" alt="">
							</div>
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h3 class="product-price"><?php echo $det[3];?> <del class="product-old-price">16.99€</del></h3>
