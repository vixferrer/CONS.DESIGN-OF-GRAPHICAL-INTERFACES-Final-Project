...
<body>
	...
	<?php
			...
			$consulta='select * from ofertas where id=3';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/camisa2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/camisa3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h3 class="product-price"><?php echo $det[3];?> <del class="product-old-price">10.99€</del></h3>
