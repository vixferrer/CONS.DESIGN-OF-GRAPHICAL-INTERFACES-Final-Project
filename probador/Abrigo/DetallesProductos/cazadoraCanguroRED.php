...
<body>
    ...
    $re=mysqli_query($con, "select * from abrigos where id=2") or die(mysql_error());
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							<div class="product-view">
								<img src="img/cazadoraCanguroRoja1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/cazadoraCanguroRoja2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/cazadoraCanguroRoja3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name">Cazadora Canguro</h2>
							<h3 class="product-price">22.99€ </h3>
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li><a href="cazadoraCanguroBlanca.php" style="background-color:rgb(233, 233, 233);"></a></li>
								</ul>
							</div>
