				...
				<form id="checkout-form" class="clearfix">
						...
						<div class="billing-details">
							...
							<!-- <div class="form-group">
								<div class="input-checkbox">
									...
									<label class="font-weak" for="register">¿Es miembro?</label>
									<div class="caption">
											<p>
					...
					<div class="col-md-6">
						...
						<div class="payments-methods">
							<div class="section-title">
								<h4 class="title">Pago elegido</h4>
							</div>
							<div class="input-checkbox">
							...
							<div class="input-checkbox">
								...
								<div class="caption">
										<p>
											<input class="input" type="text" name="password" placeholder="Correo del cliente">
											<!-- <input class="input" type="password" name="password" placeholder="Contraseña"> -->
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						<div class="order-summary clearfix">
							...
							<div class="pull-right">
								<center><a href="../..//index.php" class="volver aceptar" >Enviar ticket</a></center>
							</div>
						</div>
