...
<body>
	...
	<?php
			...
			$consulta='select * from populares where id=6';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/camisetaFlores2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/camisetaFlores3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/camisetaFlores1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/camisetaFlores2.jpg" alt="">
							</div>
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="camisetaFlorida.php" style="background-color:rgb(235, 41, 34);"></a></li>
								</ul>
							</div>
