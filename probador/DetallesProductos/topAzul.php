...
<body>
	...
	<?php
			...
			$consulta='select * from populares where id=4';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/camisetaBasicaAzul2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/camisetaBasicaAzul3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/camisetaBasicaAzul1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/camisetaBasicaAzul2.jpg" alt="">
							</div>
