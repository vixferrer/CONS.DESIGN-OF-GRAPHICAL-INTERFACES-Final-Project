...
<body>
	...
	<?php
			...
			$consulta='select * from populares where id=1';
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="camisetaMarvel.php" style="background-color:rgb(180, 180, 180);"></a></li>
								</ul>
							</div>
