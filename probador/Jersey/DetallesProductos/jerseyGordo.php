...
<body>
	...
	<?php
			...
			$consulta='select * from jerseys where id=5';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/jerseyGordo2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/jerseyGordo3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/jerseyGordo1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/jerseyGordo2.jpg" alt="">
							</div>
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(102, 71, 45);"></a></li>
								</ul>
							</div>
