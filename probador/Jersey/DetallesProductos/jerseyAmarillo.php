...
<body>
	...
	<?php
			...
			$consulta='select * from jerseys where id=1';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/jerseyAmarillo2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/jerseyAmarillo3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/jerseyAmarillo1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/jerseyAmarillo2.jpg" alt="">
							</div>
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(223, 201, 2);"></a></li>
									<li><a href="jerseyAzul.php" style="background-color:rgba(64, 163, 255, 0.596);"></a></li>
								</ul>
							</div>
