...
<body>
	...
	<?php
			...
			$consulta='select * from jerseys where id=6';
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							...
							<div class="product-view">
								<img src="img/jerseyBoyGranate2.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/jerseyBoyGranate3.jpg" alt="">
							</div>
						</div>
						<div id="product-view">
							<div class="product-view">
								<img src="img/jerseyBoyGranate1.jpg" alt="">
							</div>
							<div class="product-view">
								<img src="img/jerseyBoyGranate2.jpg" alt="">
							</div>
						...
						<div class="product-body">
							...
							<div class="product-options">
								...
								<ul class="color-option">
									...
									<li class="active"><a href="#" style="background-color:rgb(99, 0, 0);"></a></li>
									<li><a href="jerseyMarino.php" style="background-color:rgb(3, 1, 65);"></a></li>
								</ul>
							</div>
